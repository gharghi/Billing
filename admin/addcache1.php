...
<div class="page-header">
    <h1>درج تراكنش براي <?php echo $DB->Select_Result[0]['name']; ?></h1>
</div>
<div class="row">
    <div class="col-lg-12">
        ...
        <form method="POST" role="form" class="form-horizontal">
            <fieldset>
                ...
                <div class="form-group">
                    <div class="col-xs-2">
                        <label for="date" class="control-label">زمان برداشت</label>
                    </div>
                    <div class="col-xs-10 inputsize">
                        <input type="text" size="30" name="date" id="date" class="form-control"
